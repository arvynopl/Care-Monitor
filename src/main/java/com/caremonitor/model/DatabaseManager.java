...
public class DatabaseManager {
    ...
    private void seedCaregivers() throws SQLException {
        ...
        for (int i = 0; i < caregiverData.length; i++) {
            ...
            if (rs.next()) {
                ...
                switch (i) {
                    ...
                    case 1: assignedPatients = new Integer[]{3}; break;    
                    case 2: assignedPatients = new Integer[]{4, 5}; break; 
                    case 3: assignedPatients = new Integer[]{6}; break;    
                    case 4: assignedPatients = new Integer[]{7, 8}; break; 
                    case 5: assignedPatients = new Integer[]{9}; break;    
                    case 6: assignedPatients = new Integer[]{10}; break;   
        ...
        assignPatientsToCaregiver(2, new int[]{3}); 
        assignPatientsToCaregiver(3, new int[]{4, 5}); 
        assignPatientsToCaregiver(4, new int[]{6}); 
        assignPatientsToCaregiver(5, new int[]{7, 8}); 
        assignPatientsToCaregiver(6, new int[]{9}); 
        assignPatientsToCaregiver(7, new int[]{10}); 
    }
